...
export default function HistoryPage() {
  const sections = pl["history.sections"];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold tracking-tighter text-gray-900 mb-4">
            {pl["history.index.header.title"]}
          </h1>
          <p className="text-xl text-gray-800 font-medium">
            {pl["history.index.header.description"]}
          </p>
        </div>
        <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl">
          {sections.map((section, idx) => (
            <div key={idx} className="mb-10">
              ...
              <p className="text-base text-gray-900 leading-relaxed">{section.text}</p>
            </div>
          ))}
        </div>
